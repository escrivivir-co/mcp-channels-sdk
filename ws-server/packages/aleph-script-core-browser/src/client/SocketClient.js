...
class SocketClient extends events_1.AlephEventEmitter {
    constructor(config = {}) {
        super();
        this.socket = null;
        ...
        this.logger = (0, utils_1.createLogger)(this.config.name, this.config.debug);
    ...
    initialize() {
        ...
        this.socket = (0, socket_io_client_1.io)(url + namespace, {
            autoConnect,
            reconnection,
    ...
    setupEventHandlers() {
        ...
        this.socket.onAny((event, ...args) => {
            ...
            console.log(`🔍 [SOCKET-CLIENT] isLogable(${event}):`, (0, utils_1.isLogable)(event));
            console.log(`🔍 [SOCKET-CLIENT] hasListeners(${event}):`, this.hasListeners(event));
            if (!(0, utils_1.isLogable)(event)) {
